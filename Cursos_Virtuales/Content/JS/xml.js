document.addEventListener('DOMContentLoaded', function (){
    ...
    xhr.open("GET", "../xml/precio_cursos.xml", true);
...
function cargarProductos(xml){
    let productos = xml.getElementsByTagName("curso");
    let tabla = document.getElementById("TablaPrecios").getElementsByTagName("tbody")[0];
